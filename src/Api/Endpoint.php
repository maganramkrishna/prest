...
class Endpoint
{
    ...
    /**
     * Sets example of the response of the endpoint.
     *
     * @param mixed $exampleResponse
     * @return static
     */
    public function exampleResponse($exampleResponse): Endpoint
    {
    ...
    /**
     * Gets example of the response of the endpoint.
     *
     * @return mixed
     */
     ...
     * @return static
     */
    public function allow(): Endpoint
    {
