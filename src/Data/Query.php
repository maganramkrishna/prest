...
class Query
{
    ...
    public function addManyFields(array $fields)
    {
    ...
    public function addManyConditions(array $conditions)
    {
    ...
    public function addManySorters(array $sorters)
    {
    ...
    public function addManyExcludes(array $excludes)
    {
